...
export default async function Career_Details() {
    ...
    <div>
      ...
      <main className="position-relative">
        ...
        <section className="career-details-banner-section position-relative"
          style={{ backgroundImage: data.bannerImg? `url('${data.bannerImg}')`: null, backgroundRepeat: "no-repeat", backgroundPosition: "center" }}>
