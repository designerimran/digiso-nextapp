...
import $ from 'jquery';
import { home1Heading } from '@/getData/getData';
    ...
    <div className="parent-container" ref={parentContainerRef}>
      ...
      >
        <div className="image position-relative">
          <Img src={headingData.video_section_img} alt="video-image" className="img-fluid w-100" />
          <div className="play position-absolute top-50 start-50 translate-middle custom-wrapper-hover" >
            <Link className="vidplay position-relative custom-inner-hover" href={`${headingData.video_section_video}`}>
              <Img src="/assets/img/images/video-play-img.png" alt="play-button" className="img-fluid w-100" />
              <span className="position-absolute top-50 start-50 translate-middle text-uppercase">{headingData.video_section_btnName}</span>
            </Link>
          </div>
        </div>
      </div>
