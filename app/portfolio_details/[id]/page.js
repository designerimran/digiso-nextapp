...
import InnerLine from "@/app/components/common/InnerLine";
...
export default async function Portfolio_details({params}) {
  // const {id} = params;
  // const data = await portfolioDetails(id);
        ...
        <section className="portfolio-details-section">
          <div className="container px-0">
            ...
            <div className="inner-banner-img reveal zoom-out">
              <Img src={data.innerbannerImg} alt="portfolio-details-inner-banner"
                  ...
                  <div className="right-text">
                    ...
                    <div className="typhography d-flex align-items-center">
                      <div className="letter-img">
                        <Img src={data.letterImg} alt="portfolio-letter" />
                      </div>
                      <div className="info">
                        <ul className="list-unstyled">
